...
export function buildV15Html(conv, options={}) {
  ...
  return `<!doctype html><html lang="ja" data-ai-archive="v15" data-archive-version="0.3.0"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><title>${escapeHtml(conv.title)} — Archive</title><style>${v15Css()}</style></head><body>
...
function archiveSnapshot(conv){
  ...
  return {format:'AI Dialogue Conversation Snapshot',version:'0.3.0',conversation:{
